		...
		if (poly == 'A') {
			...
			for (int i = 0; i < terms.length - 1; i++) {
				if (terms[i][1] == terms[i + 1][1]) {
					a.set(counter, terms[i][0] + terms[i + 1][0]);
			...
			for (int i = 0; i < terms.length - 1; i++) {
				if (terms[i][1] == terms[i + 1][1]) {
					b.set(i + 1, terms[i][0] + terms[i + 1][0]);
				} else if (terms[i][1] - terms[i + 1][1] == 1) {
					b.add(terms[i + 1][0]);
			...
			for (int i = 0; i < terms.length - 1; i++) {
				if (terms[i][1] == terms[i + 1][1]) {
					c.set(i + 1, terms[i][0] + terms[i + 1][0]);
				} else if (terms[i][1] - terms[i + 1][1] == 1) {
					c.add(terms[i + 1][0]);
